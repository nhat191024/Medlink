...
Route::post('/profile/doctor/edit', [ProfileController::class, 'editDoctorProfile']); //! not tested
Route::post('/profile/patient/edit', [ProfileController::class, 'editPatientProfile']); //! not tested
