    ...
    <div class="rounded-lg bg-white dark:bg-gray-900 p-4">
        <div class="flex flex-wrap items-center justify-between gap-2">
            <div class="text-sm text-gray-600 dark:text-gray-300">
                <div>
                    <span class="font-medium">{{ __('appointment.modals.view_exam_result.fields.patient') }}:</span>
                    {{ optional($record->patient->user)->name ?? '—' }}
                </div>
                <div>
                    <span class="font-medium">{{ __('appointment.modals.view_exam_result.fields.doctor') }}:</span>
                    {{ optional($record->doctor->user)->name ?? '—' }}
                </div>
                <div>
                    <span class="font-medium">{{ __('appointment.modals.view_exam_result.fields.service') }}:</span>
                    {{ optional($record->service)->name ?? '—' }}
                </div>
                <div class="flex flex-wrap gap-4">
                    <div>
                        <span class="font-medium">{{ __('appointment.modals.view_exam_result.fields.date') }}:</span>
                        {{ $record->date ? \Carbon\Carbon::parse($record->date)->format('d/m/Y') : '—' }}
                    </div>
                    <div>
                        <span class="font-medium">{{ __('appointment.modals.view_exam_result.fields.time') }}:</span>
                        {{ $record->time ?? '—' }}
                    </div>
                </div>
            </div>
        ...
        <div class="mt-4">
            <div class="text-sm font-semibold mb-2">
                {{ __('appointment.modals.view_exam_result.fields.exam_result') }}
            </div>
        ...
        <div class="mt-4">
            <div class="text-sm font-semibold mb-2">
                {{ __('appointment.modals.view_exam_result.fields.medical_information') }}
            </div>
        ...
        <div class="mt-4">
            <div class="text-sm font-semibold mb-2">
                {{ __('appointment.modals.view_exam_result.fields.attachments') }}
            </div>
