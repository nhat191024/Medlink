...
@push('styles')
    <style>
        /* Smooth scrolling và cài đặt cơ bản */
        html {
        ...
        .stat-card:hover {
            ...
            box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.15), 0 0 0 1px rgba(220, 38, 38, 0.1);
        ...
        .appointment-card:hover {
            ...
            box-shadow: 0 20px 40px -12px rgba(0, 0, 0, 0.15), 0 0 0 1px rgba(220, 38, 38, 0.1);
        }
        ...
        /* DaisyUI Pagination Custom Styles */
        .pagination .btn {
