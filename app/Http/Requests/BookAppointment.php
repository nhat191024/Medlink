...
class BookAppointment extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'medical_problem_files' => 'nullable|array',
            'medical_problem_files.*' => 'file|mimes:jpg,jpeg,png,pdf|max:2048',
    ...
    public function messages(): array
    {
        return [
            ...
            'medical_problem_files.array' => 'Medical problem files must be an array of files.',
            'medical_problem_files.*.file' => 'Each medical problem file must be a valid file.',
            'medical_problem_files.*.mimes' => 'Each medical problem file must be of type: jpg, jpeg, png, pdf.',
            'medical_problem_files.*.max' => 'Each medical problem file size cannot exceed 2MB.',
